...
public class Sale {
    ...
    private double discountCurrentTotalPrice=0;
    ...
    public void addItem(ItemDTO itemDTO, int quantity) {
        ItemDTO existingItem = itemAlreadyInSale(itemDTO.getItemID());
     ...
     */
    public void increaseItemQuantity(ItemDTO itemDTO, int additionalQuantity) {
        itemDTO.setQuantity(itemDTO.getQuantity() + additionalQuantity);
    }
