...
public class InventorySystemTest {
    ...
    /**
     * This test tests if an item that exists in the inventory is fetched successfully
     */
    ...
    /**
     * This test tests if an item that does not exist in the inventory is fetched.
     */
